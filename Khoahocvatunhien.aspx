<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Khoahocvatunhien.aspx.cs" Inherits="Khoahocvatunhien" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     <asp:DataList ID="DataList2" runat="server" RepeatColumns="2" style="margin: 20px 10px 10px 10px" Width="600px">
        <ItemTemplate> 
